...
def upgrade():
    ...
    # maimai
    op.create_table('maimai_musics',
    sa.Column('bpm_min', sa.Float(), nullable=True),
    sa.Column('bpm_max', sa.Float(), nullable=True),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('label', sa.String(), nullable=True),
    sa.Column('title', sa.String(), nullable=True),
    sa.Column('title_kana', sa.String(), nullable=True),
    sa.Column('artist', sa.String(), nullable=True),
    sa.Column('image_url', sa.String(), nullable=True),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_maimai_musics')),
    sa.UniqueConstraint('label', name=op.f('uq_maimai_musics_label'))
    )
    ...
    # maimai
    op.create_table('maimai_difficulties',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('music_id', sa.Integer(), nullable=True),
    sa.Column('diff', sa.Enum('EASY', 'BASIC', 'ADVANCED', 'EXPERT', 'MASTER', 'REMASTER', name='maimaidifficulties'), nullable=True),
    sa.Column('level', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['music_id'], ['maimai_musics.id'], name=op.f('fk_maimai_difficulties_music_id_maimai_musics')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_maimai_difficulties'))
    )
    ...
    # maimai
    op.create_table('maimai_music_genres',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('music_id', sa.Integer(), nullable=True),
    sa.Column('genre', sa.Enum('Pops_Anime', 'Niconico_Vocaloid', 'Touhou', 'SEGA', 'Games_Variety', 'Original_Joypolis', name='maimaigenres'), nullable=True),
    sa.ForeignKeyConstraint(['music_id'], ['maimai_musics.id'], name=op.f('fk_maimai_music_genres_music_id_maimai_musics')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_maimai_music_genres'))
    )
    ...
    # maimai
    op.create_table('maimai_difficulty_imports',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('difficulty_id', sa.Integer(), nullable=True),
    sa.Column('batch_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['batch_id'], ['import_batches.id'], name=op.f('fk_maimai_difficulty_imports_batch_id_import_batches')),
    sa.ForeignKeyConstraint(['difficulty_id'], ['maimai_difficulties.id'], name=op.f('fk_maimai_difficulty_imports_difficulty_id_maimai_difficulties')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_maimai_difficulty_imports'))
    )
